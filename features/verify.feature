Feature: example
  ...
  @api
  Scenario: verify get user data
    # Given a Pact interaction is set up
    # Then I call and change api random user with playwright route.fulfill
    Given Pact Verification as a provider
